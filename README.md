...
Se state dando un contributo minore alla bontà del vostro cuore, visitate l'articolo e fate clic sul **collegamento Modifica** nell'articolo che porta all'origine github per l'articolo. Quindi, usa l'interfaccia utente github per effettuare gli aggiornamenti. Per ulteriori informazioni, consultate la guida Collaboratore generale [di Adobe](help/introduction.md) Docs.
