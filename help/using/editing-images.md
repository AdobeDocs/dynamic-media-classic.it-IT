...
* **Regolare un&#39;immagine**: selezionare il comando `Adjust` o il pulsante **[!UICONTROL Regola]** per capovolgere, ruotare, sfocare, colorare o modificare il bilanciamento del colore di un&#39;immagine. Vedi [Regolare un&#39;immagine](/help/using/adjusting-image.md).

* **Modifica livelli**: per visualizzare singoli livelli modificabili in un file PSD, selezionare la scheda **[!UICONTROL Livelli]**. Quando caricate un file PSD, tutti i livelli vengono caricati singolarmente come file separati, in modo da poterli modificare in Adobe Dynamic Media Classic.
