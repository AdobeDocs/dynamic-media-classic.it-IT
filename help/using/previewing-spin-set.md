...
È possibile utilizzare Elenco visualizzatori per visualizzare in anteprima come una risorsa viene visualizzata su una particolare piattaforma di tipo visualizzatore, ad esempio HTML5. A seconda del tipo di risorsa e del visualizzatore associato che hai selezionato per l’anteprima, non tutte le piattaforme sono disponibili nell’Elenco visualizzatori.
...
1. Nel pannello Libreria risorse, a sinistra, individua le cartelle di risorse che contengono il set 360 gradi da visualizzare in anteprima in un visualizzatore.
