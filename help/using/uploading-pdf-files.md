...
* Denominate i file in ordine alfanumerico per pagina La disposizione delle pagine ne semplifica l’ordine corretto dopo il caricamento dei file.
* Esaminare le pagine per verificare se le pagine di PDF contengono indicatori di ritaglio, destinazioni di registrazione o barre dei colori. Questi contrassegni determinano la posizione in cui tagliare la carta quando i documenti vengono stampati. Devono essere rimossi prima che l&#39;eCatalog venga pubblicato online. In Adobe Dynamic Media Classic sono disponibili opzioni per i segni di ritaglio durante il caricamento di file PDF.
* Se si desidera che i visualizzatori eseguano ricerche nell&#39;eCatalog per parola chiave, determinare se i file PDF sono &quot;appiattiti&quot;. Non è possibile estrarre parole di ricerca da file PDF appiattiti. Per determinare se un PDF è appiattito, provare a selezionare il testo al suo interno. Se non è possibile selezionare il testo, il PDF viene appiattito e i visualizzatori non possono eseguire ricerche per parola chiave nell&#39;eCatalog.
* Poiché sono destinati alla stampa, i file PDF in genere contengono immagini CMYK. Per impostazione predefinita, Adobe Dynamic Media Classic rileva queste immagini CMYK e le converte utilizzando un profilo colore CMYK interno. Se necessario potete anche utilizzare un profilo colore personalizzato per convertire le immagini CMYK.
...
* **Estrai parole da cercare (facoltativo)**: nella finestra di dialogo Opzioni processo di caricamento selezionare **[!UICONTROL Opzioni PDF]**. Nell&#39;elenco a discesa **[!UICONTROL Estrai]**, scegli **[!UICONTROL Parole di ricerca]** se vuoi che gli utenti possano eseguire ricerche per parola chiave nell&#39;eCatalog.

* **Generazione automatica eCatalog da PDF a più pagine (facoltativo)**: nella finestra di dialogo Opzioni processo di caricamento selezionare **[!UICONTROL Opzioni PDF]**. Fai clic su **[!UICONTROL Genera automaticamente eCatalog da PDF]** a più pagine per creare automaticamente un eCatalog al momento del caricamento. È possibile passare direttamente alla schermata eCatalog e iniziare a lavorare sull&#39;eCatalog senza prima selezionare i file PDF e selezionare il comando Genera. L’eCatalog viene denominato in base al file PDF.
