...
La nuova app desktop è disponibile come programma di installazione di `.dmg` per macOS. Programma di installazione di `.exe` per Windows®.
...
>[!IMPORTANT]
>
>È possibile installare e attivare contemporaneamente una sola istanza dell&#39;app desktop in un determinato computer. Tuttavia, non esiste alcuna restrizione al numero di installazioni che è possibile eseguire tra computer diversi.
...
No. Non vi è alcun impatto sugli script di automazione. La nuova app desktop funziona in modo simile all’esperienza basata su browser.
+++
...
Alcune aziende non consentono di scaricare e installare software e app sul sistema senza approvazione. Per ottenere l’autorizzazione per accedere alla nuova app desktop Adobe Dynamic Media Classic, coordina in anticipo con il tuo team IT. Ricorda che dopo il 31 dicembre 2020, la versione del browser è obsoleta. È importante scaricare la nuova app desktop prima della scadenza.
+++

+++**_È possibile aprire più istanze della nuova app desktop contemporaneamente?_**
No. La tecnologia Adobe® AIR® su cui viene creata la nuova app desktop Adobe Dynamic Media Classic impedisce a un utente di avere più istanze dell’app aperte in un determinato momento.
+++
...
Se Adobe rilascia una nuova versione dell&#39;app desktop, i clienti devono scaricarla e installarla (sostituirla nelle **[!UICONTROL applicazioni]**). Ricevi una notifica della nuova versione tramite il team dell’account Adobe e un meccanismo di notifica dell’aggiornamento in-app che avvisa gli utenti di un aggiornamento.
+++
...
Adobe Dynamic Media Classic è una soluzione completa progettata per supportare i flussi di lavoro rich media. Per assicurarti di utilizzare tutte le funzionalità, esplora queste risorse pratiche:
...
* [Post di blog di Adobe](https://blog.adobe.com/)
