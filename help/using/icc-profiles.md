...
In Adobe Dynamic Media Classic, potete scegliere un profilo ICC per convertire le immagini in uno spazio colore diverso quando caricate le immagini. Tutti i profili ICC standard di Adobe Photoshop sono disponibili per impostazione predefinita in Adobe Dynamic Media Classic. Per visualizzare i nomi dei profili colore nella schermata Carica, selezionate il menu Profilo colore. Quindi fai clic su **Personalizza da** > **A** e scegli un nome di profilo ICC nei menu **Convertito da** e **Convertito in**.

Consulta [Opzioni di modifica immagine al caricamento](image-editing-options-upload.md#image-editing-options-at-upload).

Oltre a utilizzare i profili ICC predefiniti, potete caricare altri profili ICC in Adobe Dynamic Media Classic e renderli disponibili per la conversione dello spazio colore. Per analizzare la classe di profilo, il tipo di spazio colore e il tipo PCS di un profilo ICC, passate a Vista dettagli nel pannello Sfoglia.
...
* Adobe Dynamic Media Classic incorpora tutti i profili Adobe Photoshop ICC standard per una conversione delle immagini affidabile.
...
* Il caricamento dei profili ICC è semplice e garantisce l&#39;accesso tra le cartelle in [!DNL Adobe Dynamic Media Classic].


## Carica profili ICC {#uploading-icc-profiles}

Caricare profili ICC con gli stessi metodi utilizzati per caricare i file. È possibile memorizzare i profili ICC in qualsiasi cartella Adobe Dynamic Media Classic.
