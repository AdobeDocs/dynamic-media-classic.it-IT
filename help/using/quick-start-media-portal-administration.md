...
Media Portal consente alle aziende di acquisire, controllare e distribuire facilmente le risorse approvate a partner e canali esterni e a utenti interni. Questo ambiente &quot;self-service&quot; basato su browser fornisce agli utenti di Media Portal &quot;viste&quot; controllate dall’amministratore nelle risorse Adobe Dynamic Media Classic per accedere facilmente a sfogliare, cercare, visualizzare in anteprima ed esportare le risorse in formati approvati dall’azienda.

In qualità di amministratore, potete definire il modo in cui gli utenti possono visualizzare, accedere e usare le risorse in Media Portal. Per adattarsi al tuo sito web e al tuo marchio, puoi personalizzare l’interfaccia di Media Portal. È possibile specificare il carattere, il colore e la dimensione del carattere e incorporare elementi di branding, ad esempio logo, nell&#39;interfaccia Media Portal.
...
La Guida introduttiva riportata di seguito è stata progettata per agevolare l&#39;amministrazione di Media Portal. Alla fine di ogni passaggio, seleziona il collegamento dell’argomento per ulteriori informazioni.

## &#x200B;1. Comprendere i ruoli utente di Media Portal

Gli utenti di Media Portal rientrano in tre ruoli: utente, collaboratore e utente-collaboratore. A ciascun ruolo è associato uno specifico set di operazioni consentite. A differenza degli utenti, i collaboratori possono rinominare o eliminare file e cartelle. Comprendi i diversi ruoli in modo che, quando aggiungi utenti, comprendi quali responsabilità gli assegni.
...
È possibile avere account FTP separati associati a Media Portal. Possono essere mappati a una cartella specifica nell’account Adobe Dynamic Media Classic. Questa funzionalità consente agli utenti di caricare risorse digitali nel tuo account utilizzando account FTP separati.

Consulta [Gestione account FTP](ftp-accounts.md#managing_ftp_accounts).

>[!NOTE]
>
>Solo gli amministratori di Media Portal possono amministrare questi account FTP. Inoltre, solo gli utenti con il ruolo Utente-Collaboratore Media Portal o Collaboratore Media Portal possono caricare file.
...
Un predefinito immagine è una raccolta di impostazioni predefinite. Queste impostazioni possono modificare le dimensioni, la qualità, il formato, la risoluzione e altri aspetti dell&#39;aspetto di un&#39;immagine esportata. Per controllare il modo in cui le immagini vengono riformattate quando gli utenti le esportano, puoi creare predefiniti immagine.
...
I metadati descrivono e identificano un file. Viene utilizzato per cercare e organizzare le risorse. Per garantire la corretta immissione dei metadati e compilare i campi obbligatori, puoi creare dei predefiniti di metadati. Un predefinito per metadati è un set preimpostato di voci di metadati. Potete inoltre creare dei campi per metadati che descrivano in modo univoco i file con cui lavorate.
