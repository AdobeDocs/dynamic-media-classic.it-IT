...
Per ordinare il contenuto di una cartella o ricerca risultati visualizzati nel pannello Sfoglia sul lato destro, nella barra di navigazione globale, selezionare **[!UICONTROL Ordina]** , quindi scegliere un&#39;opzione. Le opzioni sono **[!UICONTROL nome]** , **[!UICONTROL dimensione (KB)]** , **[!UICONTROL tipo]** , **[!UICONTROL Data di creazione]** e **[!UICONTROL Ultima modifica]** .

È inoltre possibile scegliere **** **** di ordinare risorse in ordine crescente o decrescente in base ai criteri da scegliere.
...
1. Nella libreria delle risorse, nella sezione **[!UICONTROL Cartelle]** selezionare la cartella in cui eseguire la ricerca e le relative sottocartelle.
1. A sinistra del campo Search nella libreria risorse, selezionate l&#39;icona della **[!UICONTROL lente d&#39;ingrandimento]** per aprire l&#39;elenco a discesa.
1. Nell&#39;elenco a discesa, scegliete un&#39;opzione che descriva l&#39;ampiezza o la larghezza desiderata per la ricerca. Potete scegliere **[!UICONTROL tra tutte le file &amp; cartelle]** , **[!UICONTROL all&#39;interno di cartella]** selezionate o **[!UICONTROL all&#39;interno di cartella e sottocartelle]** selezionate.
1. Nel campo Search, Inserisci un termine ricerca.
1. A destra del campo di ricerca, seleziona **[!UICONTROL Vai]** o premere **[!UICONTROL Invio]**.
...
Nella Libreria risorse, sotto il campo Ricerca, seleziona **[!UICONTROL Ricerca avanzata]** per eseguire ricerche utilizzando molti criteri, inclusi i valori nei campi di metadati.
...
* **Tutti gli stati di pubblicazione** : cerca i file contrassegnati come pronti per la pubblicazione, non contrassegnati come pronti per la pubblicazione o tutti i file.
...
* **Criteri di ricerca** : crea uno o più campi di ricerca per i metadati. Per creare i campi di ricerca, effettuate le seguenti operazioni:
   ...
   1. In Ricerca avanzata, sotto **[!UICONTROL Criteri di ricerca]** e a sinistra della sezione **[!UICONTROL Aggiungi un campo]** menu), selezionare l&#39;icona freccia triangolo giù per aprire l&#39;elenco a discesa. Scegliete una visualizzazione metadati. Potete scegliere **[!UICONTROL tutte le proprietà con valori]** , **[!UICONTROL Visualizza]** compatti, **[!UICONTROL IPTC]** , **[!UICONTROL campi]** Publish server metadati o **[!UICONTROL XMP]** .
   1. Selezionare il menu a discesa Aggiungi un campo ]**e scegliere il**[!UICONTROL  nome di un campo.
...
Nell’angolo inferiore destro del pannello Ricerca avanzata, seleziona **[!UICONTROL Ricerca]** per iniziare la ricerca. I risultati dell&#39;ricerca vengono visualizzati nel pannello Sfoglia a destra. È possibile modificare qualsiasi condizione di ricerca e selezionare **[!UICONTROL Search]** per eseguire di nuovo l&#39;ricerca.

Deselezionare ]**questa opzione**[!UICONTROL  se si desidera cancellare i criteri ricerca e avviare una nuova ricerca. Selezionate **[!UICONTROL Chiudi]** al termine della ricerca per chiudere il pannello search.
...
>[!NOTE]
>
>per le operazioni filtro è possibile utilizzare solo i campi metadati della visualizzazione metadati predefinita. Nella pagina Visualizzazioni metadati viene visualizzato il nome dei Visualizza metadati predefiniti.

Consultate [Visualizzazione metadati](application-setup.md#metadata_views).

### Eseguire un&#39;operazione di filtro {#running-a-filter-operation}

Segui questi passaggi in modo da poter individuare risorse filtrando con i relativi valori di metadati:

1. Nella Libreria risorse, seleziona la **[!UICONTROL Filtri]** scheda.
   ...
   Consulta [ Salva, Ripeti ed Elimina operazioni ](searching-assets.md#saving_repeating_and_deleting_filter_operations) filtro.

1. Seleziona **[!UICONTROL il campo]** in un pannello, quindi seguire queste istruzioni in modo da poter visualizzare il menu filtro e costruire l&#39;operazione del filtro:
   ...
   * **Rimuovere un campo di metadati** - Seleziona **[!UICONTROL Rimuovi questo pannello]** nel menu filtro.
...
1. In ciascun pannello, selezionate un valore di metadati da usare come filtro. Non è possibile selezionare più di un valore di metadati in ciascun pannello.
   ...
   Assets che corrispondono a tutti i valori selezionati visualizzati nel pannello Sfoglia.

   >[!NOTE]
   >
   >Per rimuovere temporaneamente un campo dall&#39;operazione del filtro, selezionare **[!UICONTROL Deseleziona tutto]** . Questa opzione si trova nella parte superiore di ciascun pannello, sopra metadati valori.

1. Facoltativo Per salvare l&#39;operazione di filtro e poterlo eseguire in un secondo tempo, selezionare **[!UICONTROL Seleziona predefinito]** > **[!UICONTROL Salva corrente come nuovo predefiniti]** , quindi immettete un nome nella **[!UICONTROL finestra di dialogo Salva]** .
...
* **Salvare un’operazione filtro** - Vai a **[!UICONTROL Seleziona predefinito]** > **[!UICONTROL Salva corrente come nuovo predefinito]** e quindi immettere un nome nella **[!UICONTROL Salva]** .

* **Ripetere un&#39;operazione filtro** - Scegli **[!UICONTROL Seleziona predefinito]** e scegliere il nome di un&#39;operazione filtro nel menu. Nel menu sono elencate le operazioni filtro precedentemente salvate.

* **Eliminare un&#39;operazione filtro dal menu Seleziona predefinito** : esegui l’operazione filtro. Quindi, vai a **[!UICONTROL Seleziona predefinito]** > **[!UICONTROL Elimina predefinito]** nel menu.
...
* **[!UICONTROL Pubblicazione istantanea]** : invia automaticamente tutte le modifiche ai metadati apportate, incluse nuove risorse, modifiche alle parole chiave e così via.
...
* **[!UICONTROL Parole chiave]** : pubblica le parole chiave nel server dei metadati per l&#39;utilizzo nelle ricerche.
