...
+ Zoom {#zoom}
   ...
   + [Caricamento di immagini zoom](uploading-zoom-images.md)
...
+ eCatalog {#ecatalogs}
   ...
   + [Gestione del contenuto del pannello informazioni negli eCatalogs](info-panel-content.md)
   ...
   + [Pubblicazione di eCatalogs e dei PDF associati](publishing-ecatalogs-associated-pdfs.md)
...
+ Set di immagini {#image-sets}
   ...
   + [Gestione del contenuto del pannello informazioni nei set di immagini](info-panel-content-1.md)
...
+ Integrazione Adobe Target Standard/Premium {#target-classic}
   ...
   + [Invio dei set di offerte ad Adobe Target Standard/Premium](pushing-offer-sets-target.md)
