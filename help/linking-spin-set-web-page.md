...
## Copiare un URL di un set 360 gradi {#copying-a-spin-set-url}
...
## Copia il codice di incorporamento di un visualizzatore di set 360 gradi {#copying-the-embed-code-of-a-spin-set-viewer}
