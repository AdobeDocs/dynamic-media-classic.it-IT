...
description: Scopri come collegare un set di campioni a una pagina web.
contentOwner: admin
...
1. Nel pannello delle risorse, nell’elenco a discesa Mostra, fate clic su **[!UICONTROL Set campioni]**.
