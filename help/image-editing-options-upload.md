...
|--- |--- |
| Fattore | Controlla il fattore di contrasto applicato ai pixel lungo i bordi.<br><br>Corrisponde all’intensità dell’effetto. La differenza principale tra i valori di Maschera di contrasto in Dynamic Media Classic e i valori di quantità in Adobe Photoshop, è che Photoshop ha un intervallo compreso tra 1% e 500%. In Dynamic Media Classic, invece, l&#39;intervallo di valori è compreso tra 0,0 e 5,0. In Dynamic Media Classic, il valore 5.0 equivale approssimativamente al 500% in Photoshop; un valore pari a 0,9 equivale a 90% e così via. |
