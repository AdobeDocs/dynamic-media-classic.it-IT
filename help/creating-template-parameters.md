...
1. Seleziona l’opzione Attivato accanto al nome di ciascun parametro che desideri includere nell’immagine del modello.
1. Seleziona **[!UICONTROL Chiudi]** per uscire dalla schermata Parameters (Parametri).

>[!NOTE]
>
>Potete rinominare i parametri nella schermata Parametri, in mod che sia più facile individuarlo nelle stringhe URL e più semplice usarlo come valore del database. Per rinominare un parametro, selezionane uno **[!UICONTROL On]** selezionare il nome e immettere un nuovo nome nel campo Nome.

Per visualizzare un elenco dei parametri creati per il modello, seleziona il pulsante Riepilogo parametri nella schermata Modello . Viene visualizzata la schermata Riepilogo parametri. In essa sono elencati i nomi dei vari livelli nonché i nomi e i valori di eventuali parametri.
...
1. Seleziona la **[!UICONTROL Testo]** nella schermata Parametri.
