...
**Video** pre-codificatiPuoi caricare i file MP4 direttamente in Dynamic Media Classic. Con questo flusso di lavoro, i file non vengono codificati durante il caricamento. I file vengono precodificati durante la preparazione per la visualizzazione sul desktop e sui dispositivi mobili.

**Video sorgente masterCaricare file video sorgente master e, al momento del caricamento, codificare questi file in file MP4.** Nel pannello Sfoglia, i video codificati sono etichettati “Video”. Dynamic Media Classic supporta la codifica di file video in molti formati.
...
1. Nella pagina Carica, nel pannello Seleziona file da caricare, fai clic su **Sfoglia**, individua un file video MP4 e fai clic su **Apri**.
...
La *velocità dati* (detta anche il* bit rate*) è la quantità di dati codificati per creare un singolo secondo di riproduzione video. La velocità dati è misurata in kilobit al secondo (Kbps).
...
1. In Dynamic Media Classic, fate clic su **Configurazione** > **Impostazione applicazione** > **Predefiniti video** > **Predefiniti video adattivi** o **Predefiniti codifica singola**.
...
1. Nella pagina Predefiniti per video, effettuate una delle seguenti operazioni:
   ...
   * Selezionate un predefinito per video. Nella barra degli strumenti, fate clic su **Modifica**.
      ...
      Non è possibile modificare i predefiniti di Dynamic Media Classic; puoi creare un predefinito solo da uno esistente scegliendo **Salva con nome**.
...
1. Nella pagina Aggiungi predefinito video o Modifica predefinito video, impostate le opzioni Predefinito per video desiderate.
   ...
   | Dimensione risoluzione | La dimensione della risoluzione, espressa dal valore di larghezza pixel per il valore di altezza pixel, determina la dimensione del video. Potete inserire i valori di larghezza e altezza in pixel oppure trascinare il relativo cursore per impostarli. La gamma di risoluzioni elenca le dimensioni di risoluzioni tipiche. I valori di larghezza e altezza aderiscono automaticamente alle proporzioni selezionate. Ad esempio, se si seleziona 4:3 come rapporto di formato e si immette 400 per la larghezza, 300 viene inserito automaticamente per l&#39;altezza.Se si seleziona Scala automatica per l&#39;impostazione Proporzioni, il valore Larghezza per Dimensione risoluzione viene impostato automaticamente su Auto.Fare clic su Anteprima per aprire una finestra del browser e vedere le scelte di risoluzione in tale finestra. |
