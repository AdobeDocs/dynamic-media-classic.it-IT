...
Consulta [Configurare un predefinito visualizzatore per set di file multimediali diversi](setting-mixed-media-set-viewer.md#setting-up-a-mixed-media-set-viewer-preset) e [Creare e modificare i predefiniti visualizzatore](application-setup.md#adding-and-editing-viewer-presets).
...
Selezionare il pulsante **[!UICONTROL Anteprima]** del set di file multimediali diversi. Per esaminare il set di file multimediali diversi nel visualizzatore di set di file multimediali diversi, seleziona la miniatura e le icone dei campioni. Nel menu Predefiniti, potete scegliere diversi visualizzatori.
